                                ...
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <label for="internet" class="d-inline mr-3">1</label>
                                            <input type="radio" name="internet" value="0">
                                            <label for="internet" class="d-inline">0</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <label for="tv" class="d-inline mr-3">1</label>
                                            <input type="radio" name="tv" value="0">
                                            <label for="tv" class="d-inline">0</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <label for="ac" class="d-inline mr-3">1</label>
                                            <input type="radio" name="ac" value="0">
                                            <label for="ac" class="d-inline">0</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <label for="fridge" class="d-inline mr-3">1</label>
                                            <input type="radio" name="fridge" value="0">
                                            <label for="fridge" class="d-inline">0</label>
                                        </div>
                                    </div>  
                                </div>
                            </div>
