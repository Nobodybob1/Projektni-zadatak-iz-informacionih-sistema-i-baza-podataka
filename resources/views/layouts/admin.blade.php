...
<head>
    <meta charset="utf-8">
    <title>Test projekat Agencija turisticka</title>
...
<body>
    ...
    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px; margin-bot:0px">
        <div class="row pt-5">
